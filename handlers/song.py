...
@Client.on_message(filters.command(["song", "music", " vsong", "download"]) & ~filters.private & ~filters.channel)
def song(client, message):
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    m = message.reply("⏳**Sedang mengunduh mohon tunggu...**")
